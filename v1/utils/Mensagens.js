module.exports = {
    //Mensagens Gerais
    ERRO_ALTERAR_INSTITUICAO_DIFERENTE_REGISTRO: 'Usuário não tem permissão para alterar esse registro.',
    ERRO_EXCLUIR_INSTITUICAO_DIFERENTE_REGISTRO: 'Usuário não tem permissão para excluir esse registro.',
    ERRO_CONSULTAR_OUTRA_INSTITUICAO: 'Usuário não tem permissão para consultar esse registro.',

    //Mensagens Usuario
    TAM_MIN_NOME_USUARIO: 'O nome deve ter no mínimo 5 caracteres!',
    TAM_MIN_SENHA_USUARIO: 'A senha deve ter no mínimo 5 caracteres!',
    PERFIL_INVALIDO_USUARIO: 'Perfil inválido!',
